...
alter table Associate_Status add Batch_Id char(20) Foreign Key references Batch_Info(Batch_Id),Trainer_Id char(20) Foreign Key references Trainer_Info(Trainer_Id)
alter table Associate_Status DROP COLUMN End_Date,Start_Date
alter table Associate_Status ADD End_Date DATE ,START_DATE DATE
